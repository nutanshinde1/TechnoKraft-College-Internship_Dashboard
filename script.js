...
const internTasks = {
  1: { assigned: 20, completed: 14, pending: 4, failed: 2 },
  2: { assigned: 18, completed: 12, pending: 5, failed: 1 },
  3: { assigned: 22, completed: 18, pending: 3, failed: 1 }
};
...
function viewIntern(id) {
      ...
      <div class="col-lg-4">
        <div class="card h-100">
          <div class="card-body text-center">
            ...
            />
            <h5>${intern.name}</h5>
            <p class="text-muted">${intern.domain}</p>
      ...
      <div class="col-lg-8">
        <div class="card">
          <div class="card-body">
            ...
            <p><b>College:</b> ${intern.college}</p>
            <p><b>Attendance:</b> ${intern.attendance}</p>
            <p><b>Performance:</b> ${intern.performance}</p>
          </div>
        </div>
      </div>
    </div>
  ...
  document.getElementById("assignedTasks").innerText = tasks.assigned;
  document.getElementById("completedTasks").innerText = tasks.completed;
  document.getElementById("pendingTasks").innerText = tasks.pending;
  document.getElementById("failedTasks").innerText = tasks.failed;
}
